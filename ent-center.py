...
movies = [media.Movie(
            ...
            "Taking care of Arnie is mostly Gilbert's task which can be pretty demanding, "
            "at least while you are working at the local grocery store. Then one day Becky "
            "and her grandmother passes through Endora getting trouble with the car. Gilbert "
            "falls in love with Becky, but gets problems when he tries to find time for his"
            "own private life.",
            "Drama",
            "1994",
        ...
        media.Movie(
            "The Judge",
            "Big city lawyer Hank Palmer returns to his childhood home where his father, the "
            "town's judge, is suspected of murder. Hank sets out to discover the truth and, "
        ...
        media.Movie(
            "In Bruges",
            "Guilt-stricken after a job gone wrong, hitman Ray and his partner await orders from "
            "their ruthless boss in Bruges, Belgium, the last place in the world Ray wants to be.",
            "Comedy, Crime, Drama",
            "2008",
        ...
        media.Movie(
            "Birdman",
            "A washed-up actor, who once played an iconic superhero, battles his ego and "
            "attempts to recover his family, his career and himself in the days leading "
            "up to the opening of his Broadway play.",
        ...
        media.Movie("Guardians of the Galaxy",
